<?php
//generos/fantasia.php
$pageTitle = 'Ciencia - BiblioSis';
...
try {
    $sql = "
        ...
        WHERE g.nombre = 'Fantasía y Ciencia Ficción'
...
<div class="bg-gradient-to-r from-blue-600 to-cyan-600 text-white">
    <div class="max-w-7xl mx-auto px-4 py-12">
        <div class="flex items-center space-x-2 text-sm mb-4">
            <a href="../index.php" class="text-blue-100 hover:text-white">Inicio</a>
            <span class="text-blue-300">/</span>
            <span class="text-white">Fantasía y Ciencia Ficción</span>
        </div>
        <h1 class="text-4xl font-bold mb-4">Fantasía y Ciencia Ficción</h1>
        <p class="text-lg text-blue-100">Descubre nuestros libros de divulgación científica y conocimiento</p>
    </div>
</div>
...
<script>
   document.addEventListener('DOMContentLoaded', function() {
       initializeSearch('buscar_libros.php?genero=Fantasía y Ciencia Ficción');
   });
</script>
