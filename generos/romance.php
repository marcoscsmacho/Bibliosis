...
<!-- Banner de categoría -->
<div class="bg-gradient-to-r from-red-900 to-pink-500 text-white">
    <div class="max-w-7xl mx-auto px-4 py-12">
        <div class="flex items-center space-x-2 text-sm mb-4">
            <a href="../index.php" class="text-white-300 hover:text-white">Inicio</a>
            <span class="text-white-500">/</span>
            <span class="text-white">Romance</span>
        </div>
        <h1 class="text-4xl font-bold mb-4 flex items-center">
            <i class="fas fa-heart mr-4 text-pink-300"></i>
            Romance
        </h1>
        <p class="text-lg text-blue-200">Explora nuestra colección de libros de romance</p>
    </div>
</div>
...
<script>
   document.addEventListener('DOMContentLoaded', function() {
       initializeSearch('buscar_libros.php?genero=Romance');
   });
</script>
