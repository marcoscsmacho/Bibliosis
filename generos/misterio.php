<?php
//generos/misterio.php
$pageTitle = 'Misterio y Suspenso - BiblioSis';
...
try {
   $sql = "
        ...
        WHERE g.nombre = 'Misterio y Suspenso'
...
<!-- Banner de categoría -->
<div class="bg-gradient-to-r from-gray-900 to-blue  -100 text-white">
    <div class="max-w-7xl mx-auto px-4 py-12">
        <div class="flex items-center space-x-2 text-sm mb-4">
            <a href="../index.php" class="text-stone-300 hover:text-stone-100">Inicio</a>
            <span class="text-stone-400">/</span>
            <span class="text-white">Misterio y Suspenso</span>
        </div>
        <h1 class="text-4xl font-bold mb-4">Misterio y Suspenso</h1>
        <p class="text-lg text-stone-300">Explora nuestra colección de libros de Misterio y Suspenso</p>
    </div>
</div>
...
<script>
   document.addEventListener('DOMContentLoaded', function() {
       initializeSearch('buscar_libros.php?genero=Misterio y Suspenso');
   });
</script>
